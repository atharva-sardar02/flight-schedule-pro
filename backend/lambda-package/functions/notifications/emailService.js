...
class EmailService {
    ...
    async sendWeatherAlert(to, recipientName, flightDetails) {
...
Flight Schedule Pro - Intelligent Flight Scheduling System
    ...
    async sendOptionsAvailable(to, recipientName, bookingDetails) {
...
Flight Schedule Pro - Intelligent Flight Scheduling System
    ...
    async sendDeadlineReminder(to, recipientName, deadline, hoursRemaining) {
...
Flight Schedule Pro - Intelligent Flight Scheduling System
    ...
    async sendConfirmation(to, recipientName, flightDetails) {
...
Flight Schedule Pro - Intelligent Flight Scheduling System
    ...
    async sendEscalation(to, bookingDetails) {
